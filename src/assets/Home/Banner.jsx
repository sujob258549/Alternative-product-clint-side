    ...
    return (
        <div className="md:pt-28 md:px-0 px-5 md:mt-0 mt-10">
            <div className=" w-full md:w-[80%] lg:w-[70%] mx-auto pb-8 md:pb-12">
                <h1  data-aos-duration="1000" data-aos="fade-right" className="kurali-font text-3xl md:text-5xl font-bold text-center">Banner <span className="text-[#16A34A]"><span className="text-[#16A34A]">section</span></span></h1>
                <p data-aos-duration="1000" data-aos="fade-left" className="text-center text-[18px] pt-4 md:pt-8">Choosing a different product can be a thoughtful decision influenced by various factors. One of the primary reasons for switching products is to ensure satisfaction with the quality. If the current product doesn,t meet expectations or if </p>
            </div>
            <div className="container px-6  mx-auto">
                <div className="items-center lg:flex">
                    ...
                    <div data-aos-duration="1000" data-aos="fade-right" className="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
