    ...
    <>
      ...
      >
         {/* <SwiperSlide>
                ...
                <SwiperSlide>
                    <div className="w-full bg-center bg-cover md:lg:h-[600px] md:h-[400px]  h-48" style={{ backgroundImage: "url('https://1.bp.blogspot.com/-Ir8eienXMt0/XSRTmKiRhfI/AAAAAAAAIi0/L4VQYFWw31ADz2mfos9qA7hRjE_AgMDhgCLcBGAs/s1600/blog%2Bpost%2Bcopy.png')" }}>
                ...
                <SwiperSlide>
                    <div className="w-full bg-center bg-cover md:lg:h-[600px] md:h-[400px] h-48" style={{ backgroundImage: "url('https://scontent.fspd3-1.fna.fbcdn.net/v/t39.30808-6/408908295_755257543298923_7549811742622662495_n.jpg?stp=dst-jpg_s960x960&_nc_cat=111&ccb=1-7&_nc_sid=5f2048&_nc_ohc=O1Et5WEmI6IQ7kNvgEekenU&_nc_ht=scontent.fspd3-1.fna&cb_e2o_trans=q&oh=00_AYASaJb3udz4jfEvb_J-U15iYDZ0MsT_JqHMTph-k6TUAg&oe=6644C204')" }}>
                        <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
                            <div className="text-center">
                ...
                <SwiperSlide>
                    <div className="w-full bg-center bg-cover md:lg:h-[600px] md:h-[400px] h-48" style={{ backgroundImage: "url('https://waltonbd.com/image/catalog/home-page/slider/worldwide-web-view.jpg')" }}>
                        <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
                            <div className="text-center">
