      ...
      >
         {/* <SwiperSlide>
                    <header className='max-h-[600px]'>
                        <div className="w-full bg-center bg-current bg-no-repeat md:lg:h-[600px] md:h-[400px h-48 h-48 hero-overlay" style={{ backgroundImage: "url('https://1.bp.blogspot.com/-Ir8eienXMt0/XSRTmKiRhfI/AAAAAAAAIi0/L4VQYFWw31ADz2mfos9qA7hRjE_AgMDhgCLcBGAs/s1600/blog%2Bpost%2Bcopy.png')" }}> 
                        <div>
                ...
                <SwiperSlide>
                    <div className="w-full bg-center bg-cover md:lg:h-[600px] md:h-[400px h-48 h-48" style={{ backgroundImage: "url('https://1.bp.blogspot.com/-Ir8eienXMt0/XSRTmKiRhfI/AAAAAAAAIi0/L4VQYFWw31ADz2mfos9qA7hRjE_AgMDhgCLcBGAs/s1600/blog%2Bpost%2Bcopy.png')" }}>
                ...
                <SwiperSlide>
                    <div className="w-full bg-center bg-cover md:lg:h-[600px] md:h-[400px h-48 h-48" style={{ backgroundImage: "url('https://scontent.fspd3-1.fna.fbcdn.net/v/t39.30808-6/408908295_755257543298923_7549811742622662495_n.jpg?stp=dst-jpg_s960x960&_nc_cat=111&ccb=1-7&_nc_sid=5f2048&_nc_ohc=O1Et5WEmI6IQ7kNvgEekenU&_nc_ht=scontent.fspd3-1.fna&cb_e2o_trans=q&oh=00_AYASaJb3udz4jfEvb_J-U15iYDZ0MsT_JqHMTph-k6TUAg&oe=6644C204')" }}>
                        <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
                            <div className="text-center">
                ...
                <SwiperSlide>
                    <div className="w-full bg-center bg-cover md:lg:h-[600px] md:h-[400px h-48 h-48" style={{ backgroundImage: "url('https://waltonbd.com/image/catalog/home-page/slider/worldwide-web-view.jpg')" }}>
                        <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
                            <div className="text-center">
                ...
                <SwiperSlide>
                    <div className="w-full bg-center bg-cover md:lg:h-[600px] md:h-[400px h-48" style={{ backgroundImage: "url('https://www.bashundharafood.com/assets/upload/wallpaper_1597834039.jpg')" }}>
                        <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
                            <div className="text-center">
                ...
                <SwiperSlide>
                    <div className="w-full bg-center bg-cover md:lg:h-[600px] md:h-[400px h-48 " style={{ backgroundImage: "url('https://www.shahcement.com/storage/backend.pages/yWE255hcV7rMRaXRIhtJQKmtpLfQeJcOlHnTUfDw.jpg')" }}>
                        <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
                            <div className="text-center">
                ...
                <SwiperSlide>
                    <div className="w-full bg-center bg-cover md:lg:h-[600px] md:h-[400px h-48 " style={{ backgroundImage: "url('https://www.shahcement.com/storage/backend.pages/jyYfaW1lCGa8ERT63LVh9vmImMgt06ESkzoUgRoy.jpg')" }}>
                        <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
                            <div className="text-center">
                            <h1 className="text-3xl font-bold text-white lg:text-5xl">No use other sement brand <span className="text-yellow-500 ">Use Shaha sement</span></h1>
                                <button className=" px-5 py-2 mt-4 text-sm font-medium text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Show All Details</button>
